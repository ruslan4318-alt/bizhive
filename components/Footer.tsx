                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            <li><Link className="hover:text-amber-500 transition-colors" href="/services/store-optimization">Store Optimization</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            ...
                            <li><Link className="hover:text-amber-500 transition-colors" href="/case-studies">Case Studies</Link></li>
                            <li><Link className="hover:text-amber-500 transition-colors" href="/news">News</Link></li>
                            <li><Link className="hover:text-amber-500 transition-colors" href="/studios">Studios</Link></li>
                        </ul>
                    </div>
                    <div>
